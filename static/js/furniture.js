...
window.FURNITURE = (function () {
  const items = [
    // ===== Living / bedroom =====
    {
      id: 'sofa3', name: 'Диван 3-мест', cat: 'Гостиная', w: 220, h: 90, h3d: 85,
    ...
    {
      id: 'sofa2', name: 'Диван 2-мест', cat: 'Гостиная', w: 160, h: 90, h3d: 85,
    ...
    {
      id: 'armchair', name: 'Кресло', cat: 'Гостиная', w: 90, h: 90, h3d: 85,
    ...
    {
      id: 'bed_double', name: 'Кровать 2-сп', cat: 'Спальня', w: 180, h: 200, h3d: 55,
    ...
    {
      id: 'bed_single', name: 'Кровать 1-сп', cat: 'Спальня', w: 100, h: 200, h3d: 55,
    ...
    {
      id: 'wardrobe', name: 'Шкаф', cat: 'Спальня', w: 180, h: 60, h3d: 220,
    ...
    {
      id: 'nightstand', name: 'Тумба', cat: 'Спальня', w: 50, h: 45, h3d: 55,
    ...
    {
      id: 'desk', name: 'Письм. стол', cat: 'Спальня', w: 120, h: 60, h3d: 75,
    ...
    {
      id: 'tv_stand', name: 'ТВ-тумба', cat: 'Гостиная', w: 160, h: 45, h3d: 50,
    ...
    {
      id: 'coffee_table', name: 'Журн. стол', cat: 'Гостиная', w: 110, h: 60, h3d: 45,
    ...
    {
      id: 'dining_table', name: 'Обед. стол', cat: 'Кухня', w: 140, h: 80, h3d: 75,
    ...
    {
      id: 'chair', name: 'Стул', cat: 'Кухня', w: 45, h: 45, h3d: 90,
    ...
    // ===== Kitchen =====
    {
      id: 'kitchen_l', name: 'Кухня углов.', cat: 'Кухня', w: 200, h: 60, h3d: 90,
    ...
    {
      id: 'fridge', name: 'Холодильник', cat: 'Кухня', w: 70, h: 70, h3d: 180,
    ...
    {
      id: 'stove', name: 'Плита', cat: 'Кухня', w: 60, h: 60, h3d: 90,
    ...
    {
      id: 'sink', name: 'Мойка', cat: 'Кухня', w: 80, h: 55, h3d: 90,
    ...
    {
      id: 'dishwasher', name: 'Посудомойка', cat: 'Кухня', w: 60, h: 60, h3d: 90,
    ...
    // ===== Bathroom =====
    {
      id: 'toilet', name: 'Унитаз', cat: 'Санузел', w: 40, h: 65, h3d: 75,
    ...
    {
      id: 'bathtub', name: 'Ванна', cat: 'Санузел', w: 170, h: 75, h3d: 55,
    ...
    {
      id: 'shower', name: 'Душ. кабина', cat: 'Санузел', w: 90, h: 90, h3d: 210,
    ...
    {
      id: 'sink_bath', name: 'Раковина', cat: 'Санузел', w: 60, h: 45, h3d: 85,
    ...
    {
      id: 'washing_machine', name: 'Стир. машина', cat: 'Санузел', w: 60, h: 60, h3d: 90,
    ...
    {
      id: 'boiler', name: 'Бойлер', cat: 'Санузел', w: 50, h: 80, h3d: 60,
    ...
    // ===== Misc / appliances =====
    {
      id: 'plant', name: 'Растение', cat: 'Декор', w: 50, h: 50, h3d: 120,
    ...
    {
      id: 'lamp', name: 'Лампа', cat: 'Декор', w: 40, h: 40, h3d: 150,
    ...
    {
      id: 'stairs', name: 'Лестница', cat: 'Разное', w: 100, h: 240, h3d: 30,
    ...
    {
      id: 'radiator', name: 'Батарея', cat: 'Разное', w: 80, h: 15, h3d: 60,
    ...
    {
      id: 'car', name: 'Машиноместо', cat: 'Разное', w: 250, h: 500, h3d: 160,
    ...
    {
      id: 'wardrobe_sliding', name: 'Шкаф-купе', cat: 'Спальня', w: 240, h: 70, h3d: 240,
    ...
    {
      id: 'bookshelf', name: 'Книжный шкаф', cat: 'Спальня', w: 90, h: 35, h3d: 200,
    ...
    {
      id: 'desk_office', name: 'Рабочий стол', cat: 'Кабинет', w: 140, h: 70, h3d: 75,
    ...
    {
      id: 'office_chair', name: 'Офисное кресло', cat: 'Кабинет', w: 60, h: 60, h3d: 110,
    ...
    {
      id: 'tv_wall', name: 'ТВ на стене', cat: 'Гостиная', w: 120, h: 10, h3d: 8,
    ...
    {
      id: 'fireplace', name: 'Камин', cat: 'Гостиная', w: 120, h: 40, h3d: 110,
    ...
    {
      id: 'bidet', name: 'Биде', cat: 'Санузел', w: 40, h: 60, h3d: 40,
    ...
    {
      id: 'water_heater', name: 'Водонагреватель', cat: 'Санузел', w: 50, h: 90, h3d: 150,
    ...
    {
      id: 'washer_dryer', name: 'Сушильная машина', cat: 'Санузел', w: 60, h: 60, h3d: 90,
    ...
    {
      id: 'microwave', name: 'Микроволновка', cat: 'Кухня', w: 50, h: 40, h3d: 30,
    ...
    {
      id: 'oven', name: 'Духовка', cat: 'Кухня', w: 60, h: 60, h3d: 90,
    ...
    {
      id: 'range_hood', name: 'Вытяжка', cat: 'Кухня', w: 70, h: 40, h3d: 50,
    ...
    {
      id: 'kitchen_island', name: 'Кухонный остров', cat: 'Кухня', w: 180, h: 90, h3d: 90,
    ...
    {
      id: 'bar_stool', name: 'Барный стул', cat: 'Кухня', w: 40, h: 40, h3d: 75,
    ...
    {
      id: 'pool_table', name: 'Бильярд', cat: 'Разное', w: 220, h: 110, h3d: 80,
    ...
    {
      id: 'piano', name: 'Пианино', cat: 'Разное', w: 150, h: 60, h3d: 100,
    ...
    {
      id: 'safe', name: 'Сейф', cat: 'Разное', w: 50, h: 50, h3d: 60,
